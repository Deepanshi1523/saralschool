      ...
      <div className="flex-1 col-span-6 flex flex-col justify-evenly">
        ...
        <div className="flex items-center lg:justify-between sm:justify-center ">
            <div className="inset-y-0 right-0 flex items-center pr-2 sm:static sm-inset-auto">
                <button className="text-blueviolet-500 border border-semiblueviolet-500 text-lg font-medium ml-9 py-5 px-16 transition duration-150 ease-in-out rounded-full bg-sky-200 hover:text-white hover:bg-blue-500" >Consult our Career Experts</button>
            </div>
        </div>
